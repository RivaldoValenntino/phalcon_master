  ...
  <div class="card ccard mx-auto" style="width: 98%; position: sticky">
    ...
    >
      <h4 class="card-title text-dark-m3 mt-2">
        Master - Referensi Barang - Barang
      </h4>
    ...
    <div class="modal-content radius-4">
      <div class="modal-header bgc-primary radius-t-4">
        <h4 class="modal-title text-white">
          <i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Barang
        </h4>
...
<div id="filterModal" class="modal fade" role="dialog">
  <div class="modal-dialog radius-4">
    ...
    <div class="modal-content radius-4">
      <div class="modal-header bgc-primary radius-t-4">
        <h4 class="modal-title text-white">
          <i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Barang
        </h4>
        <button type="button" class="close text-white" data-dismiss="modal">
          &times;
        </button>
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-filter">
          ...
          <div class="input-group mb-2 input-filter">
            ...
            <select
              type="text"
              id="kategori_id_search"
              name="kategori_id_search"
              class="select2 select2kategori"
              disabled=""
            ></select>
          </div>
...
<script>
  {% include 'Defaults/Master/ReferensiBarang/Barang/index.js' %}
</script>
{% endblock %}
